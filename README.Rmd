...
and alows computing a few first components.
The later feature is beneficial in practice for high-dimenstional data.
...
while other function `cpca` is used in the `cpca` devepoment branch.
