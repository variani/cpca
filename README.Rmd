...
```{r options, echo = F}
opts_chunk$set(fig.path = "doc/figures/", comment = NA, tidy = F, message = F, warning = F, echo = F, results = 'verbatim')
```
...
The same figure from the previous version of `cpca`, where both RcppEigen and RcppArmadillo
