---
title: "CPCA as a dimensionality reduction technique"
...
```{r options, echo = F}
opts_chunk$set(fig.path = "figures-dimred/", comment = NA, results = 'markup', tidy = F, message = T, warning = T, echo = T, cache = F)
```
...
pls::scoreplot(m21, col = as.numeric(Y2) + 1)
```
